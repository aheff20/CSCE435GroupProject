...
# Array of input sizes (2^16, 2^18, ..., 2^28)  65536 262144 1048576 4194304 16777216 67108864 268435456           65536	262144	1048576	4194304	16777216	67108864	268435456 
...
for size in "${inputSizes[@]}"; do
    ...
    # Execute the command with the current size and thread count
        sbatch mpi_merge.grace_job $size 128 $method
    done
    # done
done
